...
/**
 * ProfileFieldTypeRadio handles numeric profile fields.
 *
...
class Checkbox extends BaseType
{
        ...
        return parent::getFormDefinition(array(
                    get_class($this) => array(
                        ...
                        'elements' => array(
                            'options' => array(
                                'type' => 'textarea',
                                'label' => Yii::t('UserModule.models_ProfileFieldTypeCheckbox', 'Possible values'),
                                'class' => 'form-control',
                                'hint' => Yii::t('UserModule.models_ProfileFieldTypeCheckbox', 'One option per line. Key=>Value Format (e.g. yes=>Yes)')
                            ),
                        )
        )));
    }
    ...
    public function getFieldFormDefinition()
    {
        return array($this->profileField->internal_name => array(
                ...
                'prompt' => Yii::t('UserModule.models_ProfileFieldTypeCheckbox', ''),
        ));
    }
